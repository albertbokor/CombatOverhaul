...
namespace CombatExtended.HarmonyCE
{
    ...
    public static class Harmony_Pawn_HealthTracker
    {
        [HarmonyPatch(typeof(Pawn_HealthTracker), nameof(Pawn_HealthTracker.SetDead))]
        public static class Harmony_Pawn_HealthTracker_SetDead
        {
            public static void Prefix(Pawn_HealthTracker __instance)
            {
                if (__instance.pawn.Spawned)
                    __instance.pawn.Map.GetAvoidanceTracker().Notify_Death(__instance.pawn, __instance.pawn.Position);
            }
        }

        [HarmonyPatch(typeof(Pawn_HealthTracker), "CheckForStateChange")]
        public static class Harmony_Pawn_HealthTracker_CheckForStateChange
        {

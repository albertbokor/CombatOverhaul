...
namespace CombatExtended.HarmonyCE
{
    public static class Harmony_ThingGrid
    {
        ...
        //    {
        //        if (ed.def.Fillage == FillCategory.Full)
        //        {
        //            if (!ed.CanBeSeenOver())
        //            {
        ...
        //            }
        //        }
        //        else if (ed.def.Fillage == FillCategory.Partial)
        //        {
        //            if (ed.def.fillPercent > 0)
        //            {
        //                grid = __instance.map.GetComponent<WallGrid>();
        //                fillPercent = ed.def.fillPercent;
        //            }
        //        }
        //    }
